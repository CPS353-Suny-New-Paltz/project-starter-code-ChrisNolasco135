...
import user.UserComputeMultiThreadedImpl;
...
public class TestMultiUser {
	...
	private UserComputeMultiThreadedImpl networkAPI;
	
	@BeforeEach
	public void initializeComputeEngine() {
		networkAPI = new user.UserComputeMultiThreadedImpl(
	        new storage.StorageComputeImpl(),
	        new compute.ComputationImpl()
	    );
